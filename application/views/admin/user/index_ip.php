	...
	<div class="col-lg-12">
		...
		<br>
			...
			<?php if(count($users)): foreach($users as $user): ?>
					<?php if(!empty($user)): ?>	
						<tr>
							<td><?php echo anchor('admin/user/edit/' . $user[0]->id, $user[0]->login); ?></td>
							<td><?php echo $user[0]->email; ?></td>			
							<td><?php echo $user[0]->create_time; ?></td>
							<td><?php echo $user[0]->status; ?></td>
							<td><?php echo $user[0]->cash; ?></td>
							<td>
								<div class="btn-group">
								  ...
								  <ul class="dropdown-menu no_border_radius" role="menu">
								    <li><?php echo anchor('admin/user/edit/' . $user[0]->id, 'Edytuj');?></li>
								    <li>
								    	<?php 
								    	if($user[0]->status != 'OK')
								    	{
								    		echo anchor('admin/user/unblock/' . $user[0]->id, 'Odblokuj');
								    	}
								    	else
								    		echo anchor('admin/user/block/' . $user[0]->id, 'Zablokuj');?>
								    </li>
								    <li class="divider"></li>
								    <li><?php echo anchor('admin/user/block_ip/' . $user[0]->id, 'Blokada wszystkich kont');?></li>
								    <li><?php echo anchor('admin/user/delete_account/' . $user[0]->id, 'Usuń');?></li>
								  </ul>
								</div>
							</td>
						</tr>
